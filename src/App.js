...
export class App extends React.Component {
  ...
  handleAspirationButtonClicked(e) {
    ...
    switch(randomValue) {
      // Requires Cats & Dogs
      case 1: this.setState({label: "Friend of the Animals", imgSrc: require('./images/aspirations/1_friend_of_the_animals.png')}); break;
      ...
      // Requires Get Famous
      case 6: this.setState({label: "Master Actor/Actress", imgSrc: require('./images/aspirations/6_master_actor.png')}); break;
      ...
      // Requires Vampires
      case 11: this.setState({label: "Vampire Family", imgSrc: require('./images/aspirations/11_vampire_family.png')}); break;
      // Requires Parenthood
      case 12: this.setState({label: "Super Parent", imgSrc: require('./images/aspirations/12_super_parent.png')}); break;
      ...
      // Requires Vampires
      case 20: this.setState({label: "Master Vampire", imgSrc: require('./images/aspirations/20_master_vampire.png')}); break;
      // Requires Jungle Adventure
      case 21: this.setState({label: "Archaeology Scholar", imgSrc: require('./images/aspirations/21_archaeology_scholar.png')}); break;
      // Requires Realm of Magic
      case 22: this.setState({label: "Spellcraft & Sorcery", imgSrc: require('./images/aspirations/22_spellcraft_&_sorcery.png')}); break;
      ...
      // Requires City Living
      case 25: this.setState({label: "City Native", imgSrc: require('./images/aspirations/25_city_native.png')}); break;
      // Requires StrangerVille
      case 26: this.setState({label: "StrangerVille Mystery", imgSrc: require('./images/aspirations/26_strangerville_mystery.png')}); break;
      // Requires Island Living
      case 27: this.setState({label: "Beach Life", imgSrc: require('./images/aspirations/27_beach_life.png')}); break;
      ...
      case 31: this.setState({label: "Outdoor Enthusiast", imgSrc: require('./images/aspirations/31_outdoor_enthusiast.png')}); break;
      // Requires Jungle Adventure
      case 32: this.setState({label: "Jungle Explorer", imgSrc: require('./images/aspirations/32_jungle_explorer.png')}); break;
      // Requires Realm of Magic
      case 33: this.setState({label: "Purveyor of Potions", imgSrc: require('./images/aspirations/33_purveyor_of_potions.png')}); break;
      ...
      // Requires Get Together
      case 37: this.setState({label: "Leader of the Pack", imgSrc: require('./images/aspirations/37_leader_of_the_pack.png')}); break;
      // Requires Vampires
      case 38: this.setState({label: "Good Vampire", imgSrc: require('./images/aspirations/38_good_vampire.png')}); break;
      // Requires Get Famous
      case 39: this.setState({label: "World-Famous Celebrity", imgSrc: require('./images/aspirations/39_world-famous_celebrity.png')}); break;
      default: break;
    }
